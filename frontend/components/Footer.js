      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <h2 data-aos="zoom-out"
            data-aos-delay="50" className="text-3xl font-bold text-[#3ee8ff]">StyleSense</h2>
          <p data-aos="zoom-in"
            data-aos-delay="100" className="mt-4 text-gray-300 text-sm leading-relaxed">
        ...
        <div>
          <h3 data-aos="fade-right"
            data-aos-delay="100" className="text-xl font-semibold mb-4 text-[#3ee8ff]">Quick Links</h3>
          <ul className="space-y-2 text-gray-300 text-sm">
            <li data-aos="fade-left"
              data-aos-delay="150"><a href="/h" className="hover:text-white transition">Home</a></li>
            <li data-aos="fade-left"
              data-aos-delay="200"><a href="/about" className="hover:text-white transition">About Us</a></li>
            <li data-aos="fade-left"
              data-aos-delay="250"><a href="/features" className="hover:text-white transition">Features</a></li>
            <li data-aos="fade-left"
              data-aos-delay="300"><a href="/faq" className="hover:text-white transition">FAQs</a></li>
            <li data-aos="fade-left"
              data-aos-delay="350"><a href="/contact" className="hover:text-white transition">Contact</a></li>
          </ul>
        </div>
        ...
        <div>
          <h3 data-aos="fade-right"
            data-aos-delay="100" className="text-xl font-semibold mb-4 text-[#3ee8ff]">Contact Us</h3>
          <ul className="space-y-4 text-sm text-gray-300">
            <li data-aos="fade-left"
              data-aos-delay="150" className="flex items-start gap-3">
        ...
        <div>
          <h3 data-aos="fade-right"
            data-aos-delay="100" className="text-xl font-semibold mb-4 text-[#3ee8ff]">Stay in Style</h3>
          <p data-aos="zoom-in"
            data-aos-delay="200" className="text-sm text-gray-300 mb-4">
