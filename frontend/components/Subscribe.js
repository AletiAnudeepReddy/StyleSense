...
const Subscribe = () => {
    return (
        <div className="flex justify-center items-center container mx-auto rounded-2xl bg-gradient-to-r from-[#2da5b4]/80 via-[#3ee8ff]/80 to-[#2da5b4]/80 overflow-hidden relative z-10">
            <div className="w-full py-12 px-6 sm:px-12 text-center text-white">
                <h2 data-aos="fade-down"
                    data-aos-delay="50" className="text-3xl sm:text-4xl font-bold mb-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <button data-aos="fade-left"
                        data-aos-delay="100" className="px-6 py-3 bg-white text-[#2da5b4] font-semibold rounded-lg hover:bg-gray-100 transition-all">
                        Notify Me
                    </button>
                </div>

                <p data-aos="zoom-in"
                    data-aos-delay="150" className="mt-6 text-white text-md">
